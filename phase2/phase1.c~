...
main()
{
  ...
  while(str != "exit")
	...
	if (p1[0] != '\0')numparam++;
	if(p2[0] != '\0')numparam++;
      /*if(!strcmp(command,"load")||!strcmp(command,"execute")||!strcmp(command,"debug")||!strcmp(command,"dump")||!strcmp(command,"help")||!strcmp(command,"assemble")||!strcmp(command,"directory")||!strcmp(command,"exit"))
	{*/
